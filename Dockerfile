...
#
# configure vpn
#  put a copy of https://www.privateinternetaccess.com/openvpn/openvpn-strong.zip in src/pia/openvpn/${PIA_CONFIG_VERSION}
#
WORKDIR "/etc/openvpn"
RUN unzip /root/src/pia/openvpn/${PIA_CONFIG_VERSION}/openvpn-strong.zip
